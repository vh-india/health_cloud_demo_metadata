...
import { OMNIDEF } from './smallGroupQuotingEnglish_def.js';
import tmpl from './smallGroupQuotingEnglish.html';
import tmpl_nds from './smallGroupQuotingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class smallGroupQuotingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
