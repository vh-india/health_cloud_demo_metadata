...
import SDO_Commerce_DFP_Complete from '@salesforce/label/c.SDO_Commerce_DFP_Complete';
import SDO_Commerce_DFP_Current from '@salesforce/label/c.SDO_Commerce_DFP_Current';
import SDO_Commerce_DFP_Upcoming from '@salesforce/label/c.SDO_Commerce_DFP_Upcoming';
...
export default class DynamicFlowProgressLWC extends LightningElement {
    ...
    label = {
        SDO_Commerce_DFP_Complete,
        SDO_Commerce_DFP_Current,
        SDO_Commerce_DFP_Upcoming
    };
    ...
    connectedCallback(){
        ...
        if(considerCurrentStepPercentage == true) {
            ...
            if(percentProperty > 0) {
                ...
                this.progressLabel = `${percentProperty}% ${this.label.SDO_Commerce_DFP_Complete}`;
                ...
                // need a label property for the Bar indicator type that shows completion like "45% Complete"
                this.progressLabel = `${this.pathProgress}% ${this.label.SDO_Commerce_DFP_Complete}`;
